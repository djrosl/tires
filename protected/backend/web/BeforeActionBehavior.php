...
//                                    'host'          => trim(ArrayUtil::getValue($config, 'smtpHost', 'smtp.gmail.com')),
//                                    'username'      => trim(ArrayUtil::getValue($config, 'smtpUsername', 'dubztep45@gmail.com')),
//                                    'password'      => ArrayUtil::getValue($config, 'smtpPassword', 'posqjxbbcdklapng'),
//                                    'port'          => trim(ArrayUtil::getValue($config, 'smtpPort', '465')),
//                                    'encryption'    => 'tls',
                                  ];
