...
class StoreLocal extends \yii\base\Model
{
    ...
    {
        return [
                    [['country', 'timezone', 'state', 'currency', 'length_class', 'weight_class', 'language', 'phone', 'email', 'about'], 'required'],
                    ['length_class', 'integer'],
                    ['weight_class', 'integer'],
                    [['country', 'timezone', 'state', 'currency', 'length_class', 'weight_class', 'language', 'phone', 'email', 'about'], 'safe'],
               ];
    }
    ...
    public function scenarios()
    {
        ...
        $scenario['create'] = $scenario['update'] = ['country', 'timezone', 'state', 'currency', 'length_class', 'weight_class', 'language', 'phone', 'email', 'about'];
        return $scenario;
    }
