...
?>
    ...
    <div class="cardInner wrapper">
        <div class="cardInner-topTitle">
            <div class="mainTitleInner mainTitleInner__inline"><?=$this->title?></div>
            <div class="cardInner-vendorCode" data-vendorVal="<?php echo $this->product['sku'] == null ? $notSet : $this->product['sku']; ?>">Артикул: </div>
        </div>
        <div class="cardInner-preview"><img src="<?=$this->renderImages(false)?>"></div>
        <div class="cardInner-info">
            <div class="cardInner-status" data-status="available">
                <div class="cardInner-statusAvailable">В наличии</div>
                <div class="cardInner-statusDisable">Нет в наличии</div>
            </div>
            <div class="priceBlock" data-oldPrice=""><?=(int)$this->product['price']?> грн.</div>

            <?=$this->render('/front/_attributes', ['data' => $productDTO->getGroupedAttributes(), 'manufacturer'=>$this->product['manufacturer']]) ?>

            <a href="#" class="buttonGlobal buttonGlobal__100 add-cart-rs" data-productid="<?=$this->product['id']?>">добавить в корзину</a>
        </div>
        <div class="cardInner-advantages">
            <div class="cardInner-advItem cardInner-advItem__pay">
                Все способы оплаты <br> без предоплаты
            </div>
            <div class="cardInner-advItem cardInner-advItem__deliv">
                Доставка по Украине 1-3 дня <br> САМОВЫВОЗ
            </div>
            <div class="cardInner-advItem cardInner-advItem__delivMethod">
                Доставка любым удобным для Вас способом
            </div>
        </div>
    </div>
    ...
    <div class="productShow productShow__inner">
        <div class="wrapper">
            <div class="productShow-titleTop mainTitleInner">вы просматривали:</div>
