...
class HomeManager extends \common\business\Manager
{
    ...
    public function setPageData($homePageDTO)
    {
	    ...
	    $randProducts     = ProductDAO::getRandomStoreProducts($dataCategoryId, $this->language, Product::STATUS_ACTIVE, $itemsPerPage);
        ...
        $homePageDTO->setLatestProducts($latestProducts);
	      $homePageDTO->setHitProducts($randProducts);

	    $randProducts     = ProductDAO::getRandomStoreProducts($dataCategoryId, $this->language, Product::STATUS_ACTIVE, $itemsPerPage);
	    $homePageDTO->setActionProducts($randProducts);
    }
}
